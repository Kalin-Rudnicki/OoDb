...
import spyre.db.b_tree.nodes.LeafNode
        ...
        describe("node 1") {
          ...
          describe("insert 1") {
            ...
            it("modified should equal") {
              afterInsert.get._1 shouldEqual LeafNode(
                10,
                List(101, 102),
                List(201, 202),
                30
        ...
        describe("node 2") {
          ...
          describe("insert 1") {
            ...
            it("split should equal") {
              afterInsert.get._3.get shouldEqual (104, LeafNode(
                20,
                List(104),
                List(204),
                30
          ...
          describe("insert 5") {
            ...
            it("split should equal") {
              afterInsert.get._3.get shouldEqual (105, LeafNode(
                20,
                List(105),
                List(205),
                30
      ...
      describe("(size 3):") {
        ...
        describe("node 1") {
          ...
          describe("remove 2") {
            ...
            it("should equal") {
              afterRemove.get shouldEqual (202, LeafNode(
                10,
                List(104),
                List(204),
                30
          ...
          describe("remove 3") {
            ...
            it("should equal") {
              afterRemove.get shouldEqual (204, LeafNode(
                10,
                List(102),
                List(202),
                30
        ...
        describe("node 2") {
          ...
          describe("remove 2") {
            ...
            it("should equal") {
              afterRemove.get shouldEqual (202, LeafNode(10, Nil, Nil, 30), Some(
                None
              ))
            }
